...
export const YourDetailsForm = ({ profile, canUploadLogo = false }: { profile: any; canUploadLogo?: boolean }) => {
  ...
  const handleImportBusiness = (biz: BusinessProfile) => {
    const mappings: { formField: string; val: any }[] = [
      { formField: "businessId", val: biz.id || "" },
  ...
  return (
    <div className="pt-4">
      ...
      <ImageInput label="Logo" variableName="yourLogo" premium="pro" locked={!canUploadLogo} />
